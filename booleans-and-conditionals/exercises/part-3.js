let engineIndicatorLight = 'NOT red blinking';//"Any";//'NOT red blinking';
let fuelLevel =18000;//12000;//5000;//900; //21000;//"Any"; //21000;
let engineTemperature =2500;//2600;//1200;//"Any";//1200;//"Any"; //1200;
